...
/****** Object:  View [dbo].[ProjectsFull]    Script Date: 5/14/2023 10:34:47 PM ******/
SET ANSI_NULLS ON
GO
...
GO
 ...
 ALTER view [dbo].[ProjectsFull] as 
 SELECT  ROW_NUMBER() over (order by l.projectid desc) as Id,p.ProjectId,L.LevelCode as 'LevelCode',p.ManhapAllUserName,p.MNF,p.RoadRailNum,p.ControlManager,p.MainContractor,p.WBS_Num,p.OperationDepartment,p.ManagementCompany,p.MamapFullName,p.MamapUserName,
 p.ManhapFullName,P.ManhapUserName,P.PlannerAllUserName,P.Name,P.Interchange,P.TenderType,bll.Description as 'CurrentLevelDesc',L.BusinessLevelControlStatusCode,L.PhaseApprovalMamapCode,bls.Description as 'MamapStatusDesc'
 ,blsl.Description as 'ArchivStatusDesc',L.PhaseApprovalArcCode,L.Contract,L.StartBusinessLevelDate, f.CreateUser,d.IsComments,dd.IsInvalidDocs
FROM Projects P LEFT JOIN ProjectBusinessLevel L
ON P.ProjectId = L.ProjectId and P.CurrentLevelCode = L.LevelCode  left join [LOOKUP].[BusinessLevel] bll on  L.LevelCode=bll.Code
 left join [LOOKUP].[PhaseApprovalStatus] blsl on  L.PhaseApprovalArcCode = blsl.Code
 left join [LOOKUP].[PhaseApprovalStatus] bls on   L.PhaseApprovalMamapCode = bls.Code left join FavoriteProjects f
on p.ProjectId = f.ProjectId and L.LevelCode = f.LevelCode and (L.Contract = f.Contract or (L.Contract is null and f.Contract is null) ) left join (select distinct ProjectId,LevelCode,Contract,CONVERT(bit,1) as IsComments from ProjectDocuments where ManhapComments is not null) d
...
/****** Object:  StoredProcedure [dbo].[CheckIfLevelExists]    Script Date: 5/14/2023 10:34:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetCombosSP]    Script Date: 5/14/2023 10:34:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetFinishedProjectsSP]    Script Date: 5/14/2023 10:34:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetInvalidDocsSP]    Script Date: 5/14/2023 10:34:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetLookup]    Script Date: 5/14/2023 10:34:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetProjectDocTypes]    Script Date: 5/14/2023 10:34:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetProjectLevelsSP]    Script Date: 5/14/2023 10:34:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SaveOrUpdateConfig]    Script Date: 5/14/2023 10:34:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Trigger [dbo].[setArcMamapStatus]    Script Date: 5/14/2023 10:34:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
select @levelStatus = [BusinessLevelControlStatusCode] from inserted;
select @arcStatus = PhaseApprovalArcCode from inserted;
select @mamaplStatus = PhaseApprovalMamapCode from inserted;
    -- Insert statements for trigger here
if @levelStatus = 2 and ( @arcStatus = 1 or @arcStatus is null)
begin
update ProjectBusinessLevel
set PhaseApprovalArcCode = 3
from ProjectBusinessLevel l inner join inserted i on l.Id = i.Id
end
...
/****** Object:  Trigger [dbo].[ProjectClassificationTrigger]    Script Date: 5/14/2023 10:34:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Trigger [dbo].[SOABusinessLevelTrigger]    Script Date: 5/14/2023 10:34:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Trigger [dbo].[SOAImportTrigger]    Script Date: 5/14/2023 10:34:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
